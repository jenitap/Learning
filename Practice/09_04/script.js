...
gridContainer.addEventListener("mouseenter", () => {
  gridContainer.style.outline = "7px solid orange";
});
...
// For each cell, add default color
...
gridCells.forEach((cell) => {
  ...
  cell.addEventListener("mouseenter", (e) => {
    console.log(e);
    cell.style.outline = "4px solid darkblue";
  });
...
/**
 * Set page background using the s"d" key on the keyboard
 */
...
body.addEventListener("keydown", (event) => {
  ...
  if (event.code === "KeyD") {
    body.style.backgroundColor === ""
      ? (body.style.backgroundColor = "hsl(7777, 27%, 27%)")
      : (body.style.backgroundColor = "");
  }
});
